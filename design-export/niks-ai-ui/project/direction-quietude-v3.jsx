// DIRECTION — "QUIETUDE v3"
// Evolução pedida:
// (1) Alternador AM/PM: labels "manhã · noite" em serif italic sob o talismã.
//     O próprio orb reage, muda o gradient. Sem componente novo.
// (2) Bottom sheet por passo para detalhes completos — preserva a tela principal limpa.
//     Chevron › à direita indica tocabilidade.

function ProtocoloQuietudeV3({ accent = PROTO.coral, displayFont = PROTO.serif, mode: initialMode = 'am' }) {
    ...
    <div style={{
      ...
      <div style={{ padding: '56px 28px 0', display: 'flex', justifyContent: 'center' }}>
        <div style={{
          ...
          {/* Moon craters — only in PM, subtle shadows */}
          {isPM && (
            <>
      ...
      <div style={{
        ...
        >
          ...
          <svg width="13" height="13" viewBox="0 0 14 14" fill="none" style={{ transition: 'opacity 300ms ease' }}>
      ...
      {/* Title block */}
      <div style={{ padding: '26px 8px 0', textAlign: 'center' }}>
        <div style={{
          fontFamily: displayFont, fontSize: 38, fontWeight: 400,
          color: ink, lineHeight: 1.05, letterSpacing: '-0.035em',
          whiteSpace: 'nowrap',
        }}>
      ...
      {ritualOpen && (
        <div style={{
          ...
          animation: 'qv3-cerim-in 420ms cubic-bezier(0.25, 1, 0.5, 1)',
        }}>
          <style>{`
            @keyframes qv3-cerim-in {
...
Object.assign(window, { ProtocoloQuietudeV3 });
