...
*Última atualização: Sessão 15 — Março 2026*
*Status: MVP — Consentimento de IA implementado (LGPD/App Store compliance); ícone Settings removido da tela de perfil. IA migrada para Gemini 2.5 Pro; exclusão de conta implementada. Push notifications: token real pendente até Apple Developer Program ativo. RevenueCat pendente.*