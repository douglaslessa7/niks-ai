...
> App mobile de análise de pele com inteligência artificial.

---

## Sobre o projeto

<O seu plano original para esse projeto, que eu aprovei, foi esse aqui:
...
Continue de onde parou conforme o PROGRESSO2.md e o seu plano original.
...
- **Expo Router** v3 (navegação por arquivos)
- **NativeWind** v4 (Tailwind CSS para RN)
- **TypeScript**
- **react-native-svg** (gráficos e Score ring)
...
│   ├── (scan)/                    # Fluxo de scan de pele/comida
│   └── (app)/                     # App principal (tabs)
├── components/
│   ├── ui/                        # Componentes base (CTAButton, Pill, etc.)
│   ├── layouts/                   # QuizLayout
│   └── scan/                      # ScanModal
├── constants/
