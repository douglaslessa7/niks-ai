...
const STEPS = [
  { at: 17, label: 'Mapeando os pontos do seu rosto' },
  { at: 34, label: 'Identificando seu tipo de pele' },
  { at: 51, label: 'Avaliando oleosidade da pele' },
  { at: 68, label: 'Identificando manchas e pigmentação' },
  { at: 84, label: 'Avaliando textura e poros da pele' },
  { at: 100, label: 'Detectando necessidades da pele' },
];
...
export default function LoadingDentroApp() {
  ...
  const { skinImageBase64, skinImageUri, onboarding, setScanResult, setSelectedScan, setSkinPreviewUrl } = useAppStore();
