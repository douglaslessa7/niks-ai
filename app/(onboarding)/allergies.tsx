    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: CREAM }}>
      <View style={{ flex: 1, maxWidth: 393, width: '100%', alignSelf: 'center' }}>
        ...
        <View style={{ paddingHorizontal: 28, paddingTop: 28 }}>
          ...
          <Text style={{
            fontFamily: fXBold, fontSize: 24, fontWeight: '800', color: DEEP,
            letterSpacing: -0.85, lineHeight: 26.4,
          }}>
            {'Você tem alguma '}
            <Text style={{
            ...
            {' ou sensibilidade a produtos de skincare?'}
          </Text>
          <Text style={{
          ...
          {OPTIONS.map(({ label, value }) => {
            ...
            return (
              <TouchableOpacity
                ...
                style={{
                  minHeight: 70, borderRadius: 100, backgroundColor: '#FFFFFF',
                  borderWidth: isSelected ? 1.5 : 0.5,
                  borderColor: isSelected ? CORAL : DEEP_HAIR,
                  paddingLeft: 26, paddingRight: 22, paddingVertical: 14,
