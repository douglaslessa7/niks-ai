...
export default function SocialIntro() {
  ...
  useEffect(() => {
    track('onboarding_step_viewed', { step_number: 1, step_name: 'Social Intro', step_total: 28 });
  }, []);

  const handleContinue = async () => {
    await Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
    track('onboarding_step_completed', { step_number: 1, step_name: 'Social Intro', step_total: 28 });
    router.push('/(onboarding)/transformation-preview');
  };
  ...
  return (
    ...
    <SafeAreaView style={{ flex: 1 }}>
      <View style={{
        ...
        {/* Hero — phone frame, flex:1, centered */}
        ...
        <View style={{ flexShrink: 0, paddingHorizontal: 28 }}>
          ...
          <Text style={{
            ...
            Mais de 10.000 pessoas já pararam de se esconder e transformaram a pele com NIKS AI
          </Text>
        </View>
      ...
      {__DEV__ && (
        <TouchableOpacity
          onPress={() => router.replace('/(onboarding)/plan-preview')}
          style={{
            position: 'absolute',
            bottom: 100,
            right: 16,
