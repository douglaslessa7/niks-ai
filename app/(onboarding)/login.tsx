          ...
          >
            ...
            <View style={{ paddingTop: 34, paddingHorizontal: 28 }}>
              ...
              <Text style={{ fontFamily: fReg, marginTop: 14, fontSize: 14.5, lineHeight: 21.75, color: DEEP_SOFT, letterSpacing: -0.1 }}>
                ...
                <Text style={{ fontFamily: fXBold, fontWeight: '800', color: DEEP }}>NIKS</Text>
              ...
              {step === 'password' && (
                <View>
                  ...
                  <TouchableOpacity activeOpacity={0.7} style={{ alignSelf: 'flex-end', marginTop: 8 }}>
                    <Text style={{ fontFamily: fReg, fontSize: 13, fontWeight: '500', color: CORAL, letterSpacing: -0.1 }}>
                      Esqueceu sua senha?
                    </Text>
                  </TouchableOpacity>
                </View>
              ...
              {step === 'email' ? (
                ...
                >
                  {localLoading
                    ...
                    : <Text style={{ fontFamily: fSemi, fontSize: 17, fontWeight: '600', letterSpacing: -0.2, color: passwordActive ? '#FFFFFF' : 'rgba(255,255,255,0.92)' }}>Entrar</Text>
                  }
                </TouchableOpacity>
              )}
                  ...
                  >
                    {loading ? <ActivityIndicator color={DEEP} /> : (
                      <>
                        ...
                        <Text style={{ fontFamily: fSemi, fontSize: 16, fontWeight: '600', color: DEEP, letterSpacing: -0.15 }}>Entrar com Google</Text>
                      </>
                    )}
                  </TouchableOpacity>
                    ...
                    >
                      {loading ? <ActivityIndicator color="#FFFFFF" /> : (
                        <>
                          ...
                          <Text style={{ fontFamily: fSemi, fontSize: 16, fontWeight: '600', color: '#FFFFFF', letterSpacing: -0.15 }}>Entrar com Apple</Text>
                        </>
                      )}
                    </TouchableOpacity>
                  )}
